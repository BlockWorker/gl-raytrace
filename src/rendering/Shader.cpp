...
void Shader::setUniform2fv(const std::string& uniformName, GLsizei count, const glm::vec2 * vectors)
{
    if (uniformsLocations.count(uniformName))
    {
        glProgramUniform2fv(program_id, uniformsLocations[uniformName], count, &(vectors->x));
    }
    else if (getUniformLocation(uniformName))
    {
        glProgramUniform2fv(program_id, uniformsLocations[uniformName], count, &(vectors->x));
...
void Shader::setUniform3fv(const std::string& uniformName, GLsizei count, const glm::vec3 * vectors)
{
    if (uniformsLocations.count(uniformName))
    {
        glProgramUniform3fv(program_id, uniformsLocations[uniformName], count, &(vectors->x));
    }
    else if (getUniformLocation(uniformName))
    {
        glProgramUniform3fv(program_id, uniformsLocations[uniformName], count, &(vectors->x));
...
void Shader::setUniform4fv(const std::string& uniformName, GLsizei count, const glm::vec4 * vectors)
{
    if (uniformsLocations.count(uniformName))
    {
        glProgramUniform4fv(program_id, uniformsLocations[uniformName], count, &(vectors->x));
    }
    else if (getUniformLocation(uniformName))
    {
        glProgramUniform4fv(program_id, uniformsLocations[uniformName], count, &(vectors->x));
