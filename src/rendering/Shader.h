...
public:
    ...
    void setUniform2fv      (const std::string & uniformName, GLsizei count, const glm::vec2 * vectors);
    void setUniform3fv      (const std::string & uniformName, const glm::vec3 & vector);
    void setUniform3fv      (const std::string & uniformName, GLsizei count, const glm::vec3 * vectors);
